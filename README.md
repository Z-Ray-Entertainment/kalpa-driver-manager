...
[![build result](https://build.opensuse.org/projects/devel:microos:kalpa/packages/kalpa-driver-manager/badge.svg?type=default)](https://build.opensuse.org/package/show/devel:microos:kalpa/kalpa-driver-manager)
